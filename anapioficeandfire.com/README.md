...
Thoroughly read through this file to understand whatand the ANSWERME.md file to get a feel of what needs to happen
Think of your solution, what is your approach going to be
Start programming (the fun part!)
Check the functionality list to ensure that you have built everything that is expected
Go over your code and ensure that it is clean (code clarity / modularisation). That means:
...
Answer the questions in the ANSWERME.md file
Upload your final files to your github
Send the link to your github project to @Rob van Kruijsdijk on slack
Grading
...
In case you copy (a line of) code from somewhere else, you must place a reference. Otherwise it is seen as plagiarism.
No contact with others during the test.
Do not share your test with anybody
Hand in your work on time. You have 3 hours in total.
 -->
